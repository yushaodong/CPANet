...
if __name__ == '__main__':
    ...
    x = torch.FloatTensor(4, 3, 200, 200)
    print(x.shape)
    x_size = x.size()

    query_feat_0 = resnet.layer0(x)
    print(query_feat_0.shape)  # [1, 128, 50, 50]
    query_feat_1 = resnet.layer1(query_feat_0)
    print(query_feat_1.shape)  # [1, 256, 50, 50]
    query_feat_2 = resnet.layer2(query_feat_1)
    print(query_feat_2.shape)   # [1, 512, 25, 25]  -- block2
    query_feat_3 = resnet.layer3(query_feat_2)
    print(query_feat_3.shape)   # [1, 1024, 25, 25] -- block3
    query_feat_4 = resnet.layer4(query_feat_3)
    print(query_feat_3.shape)   # [1, 1024, 25, 25]  -- block4
